...
static function array<X2DataTemplate> CreateTemplates()
{
	...
	Templates.AddItem(CreateTemplarShieldListenerTemplates());

	return Templates;
}

private static function CHEventListenerTemplate CreateTemplarShieldListenerTemplates()
{
	local CHEventListenerTemplate Template;

	`CREATE_X2TEMPLATE(class'CHEventListenerTemplate', Template, 'IRI_X2EventListener_TemplarShield');
